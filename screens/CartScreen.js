...
import { increamentQuantity, removeFromCart } from '../redux/CartReducer';
import { decreamentQuantity } from '../redux/CartReducer';
                ...
                {cart?.map((item, index) => (
                    <View key={index}
                        ...
                        <Pressable style={{ marginTop: 15, marginBottom: 10, flexDirection: 'row', alignItems: "center", gap: 10 }}>
                            <View style={{ flexDirection: "row", alignItems: "center", paddingHorizontal: 10, paddingVertical: 10, borderRadius: 7 }}>
