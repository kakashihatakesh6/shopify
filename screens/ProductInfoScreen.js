        ...
        <ScrollView style={{ marginTop: 55, flex: 1, backgroundColor: "white" }} showsVerticalScrollIndicator={false}>
                ...
                {route.params.carouselImages.map((item, index) => {
                    ...
                    >
                        <View style={{ padding: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                            ...
                            <View style={{
                                width: 40, height: 40, borderRadius: 20, flexDirection: "row",
                                backgroundColor: "#C60C30", alignItems: "center", justifyContent: "center"
                            }}>
                        ...
                        <View style={{
                            width: 40, height: 40, borderRadius: 20, flexDirection: "row",
                            backgroundColor: "#E0E0E0", alignItems: "center", justifyContent: "center", marginTop: "auto", marginLeft: 20, marginBottom: 20
                        }}>
            ...
            <View style={{ padding: 10 }}>
                ...
                <View style={{flexDirection: "row", marginVertical: 5, alignItems: "center", gap: 5}}>
                    ...
                    <Text style={{ fontSize: 15, fontWeight: "500"}}>Deliver to Nikhil - Banglore 334994</Text>
                </View>
            ...
            <Pressable onPress={() => addItemToCart(route?.params?.item)} style={{backgroundColor: "#FFC72C", padding: 10, borderRadius: 20, justifyContent: "center",alignItems: "center", alignItems: "center", marginHorizontal: 10, marginVertical: 10}}>
                {addedToCart ? (
                    <View>
            ...
            <Pressable style={{backgroundColor: "#FFAC1C", padding: 10, borderRadius: 20, justifyContent: "center",alignItems: "center", alignItems: "center", marginHorizontal: 10, marginVertical: 10}}>
                <Text>Buy Now</Text>
            </Pressable>
