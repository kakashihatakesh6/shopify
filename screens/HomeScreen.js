...
const HomeScreen = () => {
  ...
  const fetchAddresses = async () => {
    try {
      ...
      const res = await axios.get(`${process.env.IP_ADDRESS}/addresses/${userId}`)
    ...
    <>
      <SafeAreaView style={{
        ...
        <ScrollView>
          ...
          {/*Horizontal Scroll view Top bar  */}
          ...
          <SliderBox
            ...
            ImageComponenetStyle={{ width: "100%" }}>
          </SliderBox>
          ...
          {/* PRODUCT INFO TODAY'S OFFERS SCROLL VIEW */}
      ...
      <BottomModal
        onBackdropPreess={() => setModalVisible(!modalVisible)}
      ...
      >
        <ModalContent style={{ width: "1000%", height: 400 }}>
          <View style={{ marginBottom: 8 }}>
            <Text style={{ fontSize: 15, fontWeight: "500" }}>Choose Your Location</Text>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            ...
            {addresses?.map((item, index) => (
              <Pressable onPress={() => setSelectedAddress(item)} key={index}
                style={{
                  width: 140, height: 140, borderColor: "#D0D0D0", borderWidth: 1,
                ...
                <Text numberOfLines={1} style={{ width: 130, fontSize: 13, textAlign: "center" }}>{item?.houseNo}, {item?.landmarks}</Text>
                <Text numberOfLines={1} style={{ width: 130, fontSize: 13, textAlign: "center" }}>{item?.street}</Text>
                <Text numberOfLines={1} style={{ width: 130, fontSize: 13, textAlign: "center" }}>India, Banglore</Text>
